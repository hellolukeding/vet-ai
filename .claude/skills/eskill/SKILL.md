...
Eskill 是 AI agents (Claude, Cursor, Windsurf) 的统一技能管理工具。它支持从 Git 仓库安装技能、管理本地/全局技能集合、搜索 SkillsMP 市场，以及保持技能更新。
...
# 为特定的 agent 安装 (claude, cursor, windsurf)
...
从 `~/.eskill/skills/` 创建软链接到 `./.claude/skills/`。
